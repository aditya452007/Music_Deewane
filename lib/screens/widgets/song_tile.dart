...
import 'package:music_deewane/screens/screen/common_views/song_info_screen.dart';
          ...
          child: AnimatedContainer(
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                onTap: widget.onTap,
                onLongPress: widget.onOptionsTap,
                onSecondaryTap: widget.onOptionsTap,
                child: Padding(
                        ...
                        children: [
                          ...
                          if (widget.delDownBtn)
                            _ActionButton(
                              ...
                              onTap: () {
                                try {
                                  if (playerCubit.player.currentMedia.id !=
                                      song.id) {
                                    context
