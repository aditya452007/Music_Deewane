...
class ChartListTile extends StatelessWidget {
  ...
  Widget _buildTrendTag(Trend trend, int? change) {
    switch (trend) {
      ...
      case Trend.up:
        return _buildArrow('â†‘', change, Default_Theme.successColor);
      case Trend.down:
        return _buildArrow('â†“', change, Default_Theme.accentColor2);
      case Trend.unknown:
