...
import 'package:music_deewane/l10n/language_options.dart';
...
import 'package:music_deewane/utils/country_info.dart';
...
class _OnboardingOverlayState extends State<OnboardingOverlay> {
  ...
  Future<void> _loadInitial() async {
    ...
    _updateCountryFromDeviceLocaleIfNeeded(shouldGuess: storedCountry.isEmpty);
  }
  ...
  Future<void> _updateCountryFromDeviceLocaleIfNeeded({
    ...
    if (!mounted || guessed == null || _countryTouchedByUser) return;
    setState(() => _selectedCountry = guessed);
  ...
  Future<void> _updateAutoDetect(bool val) async {
    setState(() => _autoDetectCountry = val);
                    ...
                    Expanded(
                      child: Center(
                        child: _StepLanguage(
                          ...
                          isResolvingCountry: _isResolvingCountry,
                          languageItems: _buildLanguageItems(l10n),
                          countryItems: countries.entries.toList()
                            ..sort((a, b) => a.key.compareTo(b.key)),
                          onLangChanged: _updateLang,
                          onCountryChanged: _updateCountry,
                          onAutoDetectChanged: _updateAutoDetect,
                        ),
                      ),
                    ),
...
class _StepLanguage extends StatelessWidget {
  ...
  final bool isResolvingCountry;
  final List<DropdownMenuItem<String>> languageItems;
  final List<MapEntry<String, String>> countryItems;
  ...
  const _StepLanguage({
    ...
    required this.autoDetectCountry,
    required this.isResolvingCountry,
  ...
  Widget build(BuildContext context) {
    ...
    final selectedCountry = countries.containsValue(this.selectedCountry)
    ...
    return SingleChildScrollView(
      ...
      child: ConstrainedBox(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: _OnboardingOverlayState._cardColor,
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Expanded(
                    child: _FieldLabel(label: l10n.countrySettingAutoDetect),
                  ),
                  ...
                  if (isResolvingCountry) const SizedBox(width: 10),
                  _AestheticSwitch(
                    value: autoDetectCountry,
              ...
              AnimatedOpacity(
                opacity: autoDetectCountry ? 0.6 : 1,
                duration: const Duration(milliseconds: 180),
                child: IgnorePointer(
                  ignoring: autoDetectCountry,
