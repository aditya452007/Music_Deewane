...
class _LegacyMigrationOverlayState extends State<LegacyMigrationOverlay>
  ...
  static const _successAccent = Color(0xFFFF2A5F); // Music Deewane Pink/Red
    ...
    return ValueListenableBuilder<_Phase>(
      ...
      builder: (context, phase, _) {
        final title = switch (phase) {
          _Phase.running => 'Upgrading Music Deewane',
          _Phase.success => 'Welcome to Music Deewane 3.0',
  ...
  Widget _buildActionButton() {
    ...
    return Container(
      ...
      child: FilledButton(
        ...
        child: Text(
          isErr ? 'Retry Migration' : 'Enter Music Deewane',
