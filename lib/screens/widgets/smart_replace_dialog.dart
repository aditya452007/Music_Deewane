...
class _SmartReplaceDialogState extends State<_SmartReplaceDialog> {
  ...
  void initState() {
    ...
    _service = SmartTrackReplacementService.create(
      context.read<MusicDeewanePlayerCubit>().player.pluginService,
    );
                    ...
                    children: [
                      if (index == 0)
                        Padding(
                          ...
                          child: MusicDeewaneDialogBadge(
                              l10n.smartReplaceBestMatch),
                        ),
                      isApplying
                          ? const SizedBox(
                              width: 20,
