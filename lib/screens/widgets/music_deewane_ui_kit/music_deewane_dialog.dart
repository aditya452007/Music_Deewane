...
/// Music Deewane-branded dialog surface.
///
...
///   actions: [
///     MusicDeewaneDialogAction.text('Cancel'),
///     MusicDeewaneDialogAction.filled('Delete', isDestructive: true, onPressed: () {}),
///   ],
/// );
/// ```
class MusicDeewaneDialogAction {
  final String label;
  final VoidCallback? onPressed;
  final bool isDestructive;
  final bool isFilled;

  const MusicDeewaneDialogAction.text(
    this.label, {
    this.onPressed,
    this.isDestructive = false,
  }) : isFilled = false;

  const MusicDeewaneDialogAction.filled(
    this.label, {
    this.onPressed,
    this.isDestructive = false,
  }) : isFilled = true;
...
/// Display the standard Music Deewane dialog.
Future<T?> showMusicDeewaneDialog<T>({
  required BuildContext context,
  required String title,
  String? subtitle,
  Widget? body,
  IconData? icon,
  List<MusicDeewaneDialogAction>? actions,
  ...
  return showDialog<T>(
    ...
    builder: (_) => MusicDeewaneDialogSurface(
      title: title,
      subtitle: subtitle,
      body: body,
      icon: icon,
...
class MusicDeewaneDialogSurface extends StatelessWidget {
  final String title;
  final String? subtitle;
  final Widget? body;
  final IconData? icon;
  final List<MusicDeewaneDialogAction>? actions;

  const MusicDeewaneDialogSurface({
    super.key,
    required this.title,
    this.subtitle,
    this.body,
  ...
  Widget _buildAction(BuildContext context, MusicDeewaneDialogAction action) {
...
/// A Music Deewane-styled list-tile for use inside dialog bodies.
///
...
class MusicDeewaneDialogTile extends StatelessWidget {
  final String title;
  final String? subtitle;
...
class MusicDeewaneDialogBadge extends StatelessWidget {
  final String label;
  final Color? color;

  const MusicDeewaneDialogBadge(this.label, {super.key, this.color});
