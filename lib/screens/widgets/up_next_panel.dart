...
class _UpNextPanelState extends State<UpNextPanel> {
  ...
  late final MusicDeewanePlayerCubit _playerCubit;

  @override
  void initState() {
    super.initState();
    _playerCubit = context.read<MusicDeewanePlayerCubit>();
...
class _PanelContent extends StatelessWidget {
  ...
  final MusicDeewanePlayerCubit playerCubit;
      ...
      child: Row(
        ...
        children: [
          StreamBuilder<List<MediaItem>>(
            stream: playerCubit.player.queue,
...
class _ClearQueueButton extends StatefulWidget {
  final MusicDeewanePlayerCubit playerCubit;
  const _ClearQueueButton({required this.playerCubit});

  @override
  State<_ClearQueueButton> createState() => _ClearQueueButtonState();
}

class _ClearQueueButtonState extends State<_ClearQueueButton> {
  ...
  Widget build(BuildContext context) {
    return MouseRegion(
      ...
      child: GestureDetector(
        onTap: () => widget.playerCubit.player.clearQueue(),
...
class _DesktopSongListState extends State<_DesktopSongList> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<MediaItem>>(
      stream: widget.playerCubit.player.queue,
      builder: (context, queueSnapshot) {
        ...
        return StreamBuilder<MediaItem?>(
          stream: widget.playerCubit.player.mediaItem,
          builder: (context, mediaSnapshot) {
            ...
            return ReorderableListView.builder(
              ...
              onReorderItem: widget.playerCubit.player.moveQueueItem,
...
class _QueueItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget content = Dismissible(
      ...
      onDismissed: (_) => playerCubit.player.removeQueueItemAt(index),
      child: Material(
        color: Colors.transparent,
        child: Padding(
            ...
            children: [
              Expanded(
                child: SongCardWidget(
                  showOptions: false,
                  onTap: () => playerCubit.player.skipToQueueItem(index),
                  song: songModel,
                  trailing: IconButton(
