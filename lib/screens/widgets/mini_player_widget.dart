  ...
  Widget build(BuildContext context) {
    ...
    if (state.isCompleted) {
      return _ControlButton(
        ...
        onPressed: () {
          HapticFeedback.mediumImpact();
          context.read<MusicDeewanePlayerCubit>().player.rewind();
        },
      );
    }
    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        onTap: () {
          HapticFeedback.lightImpact();
          state.isPlaying
              ? context.read<MusicDeewanePlayerCubit>().player.pause()
              : context.read<MusicDeewanePlayerCubit>().player.play();
        },
        child: Container(
          width: 42,
          height: 42,
  ...
  Widget build(BuildContext context) {
    return Positioned(
      ...
      child: StreamBuilder<ProgressBarStreams>(
        stream: context.watch<MusicDeewanePlayerCubit>().progressStreams,
