...
import 'package:music_deewane/screens/screen/player_views/fullscreen_lyrics_view.dart';
import 'package:music_deewane/screens/widgets/snackbar.dart';
import 'package:music_deewane/screens/widgets/smart_replace_dialog.dart';
import 'package:music_deewane/screens/widgets/song_tile.dart';
import 'package:music_deewane/services/song_metadata_refresh_service.dart';
...
class _TrackOptionsBottomSheet extends StatelessWidget {
  ...
  const _TrackOptionsBottomSheet({
    ...
    required this.showPlayerActions,
                      ...
                      child: Column(
                        ...
                        children: [
                              ...
                              children: [
                                if (showPlayerActions) ...[
                                  _CompactTile(
                                    ...
                                    title: l10n.playerTimer,
                                    onTap: (ctx) {
                                      Navigator.pop(ctx);
                                      Navigator.push(
                                        ctx,
                                        MaterialPageRoute(
                                            builder: (_) => const TimerView()),
                                      );
                                    },
                                  ),
                                  _CompactTile(
                                    icon: MingCute.align_center_line,
                                    title: l10n.playerLyrics,
                                    onTap: (ctx) {
                                      Navigator.pop(ctx);
                          ...
                          _CompactTile(
                            ...
                            onTap: (ctx) async {
                              final player =
                                  ctx.read<MusicDeewanePlayerCubit>().player;
                              Navigator.pop(ctx);
