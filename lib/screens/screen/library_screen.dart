...
import 'package:music_deewane/plugins/blocs/import/content_import_state.dart';
import 'package:music_deewane/core/models/media_playlist_model.dart';
import 'package:music_deewane/screens/screen/library_views/more_opts_sheet.dart';
import 'package:music_deewane/screens/screen/common_views/album_view.dart';
import 'package:music_deewane/screens/screen/common_views/artist_view.dart';
import 'package:music_deewane/screens/screen/common_views/playlist_view.dart';
...
import 'package:music_deewane/blocs/library/search_cubit/library_search_cubit.dart';
import 'package:music_deewane/core/models/library_search_result.dart';
import 'package:music_deewane/screens/widgets/animated_list_item.dart';
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _EmptyLibraryAction(
                              ...
                              label: l10n.libraryEmptySearch,
                              onTap: () =>
                                  context.goNamed(RoutePaths.searchScreen)),
                          const SizedBox(height: 10),
                          _EmptyLibraryAction(
                              icon: FontAwesome.file_import_solid,
                              label: l10n.libraryEmptyImport,
                              onTap: () => context.pushNamed(
                                  RoutePaths.importMediaFromPlatforms)),
                          const SizedBox(height: 10),
                          _EmptyLibraryAction(
            ...
            child: SongCardWidget(
              ...
              onTap: () async {
                ...
                if (playlist != null && context.mounted) {
                  ...
                  context.read<MusicDeewanePlayerCubit>().player.loadPlaylist(
                        playlist,
...
class _EmptyLibraryAction extends StatelessWidget {
  final IconData icon;
  final String label;
  final VoidCallback onTap;
  const _EmptyLibraryAction(
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: OutlinedButton.icon(
        onPressed: onTap,
        icon: Icon(icon, size: 18, color: Default_Theme.accentColor2),
        label: Text(label,
            style: const TextStyle(
                color: Default_Theme.primaryColor1, fontSize: 14)),
