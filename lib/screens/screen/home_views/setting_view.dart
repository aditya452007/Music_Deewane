...
import 'package:music_deewane/screens/screen/home_views/setting_views/manage_preferences_screen.dart';
import 'package:music_deewane/screens/screen/home_views/setting_views/local_music_setting.dart';
import 'package:music_deewane/screens/screen/home_views/setting_views/plugin_defaults_setting.dart';
import 'package:music_deewane/screens/screen/home_views/setting_views/storage_setting.dart';
import 'package:music_deewane/screens/screen/home_views/setting_views/country_setting.dart';
import 'package:music_deewane/screens/screen/home_views/setting_views/download_setting.dart';
import 'package:music_deewane/screens/screen/home_views/setting_views/lastfm_setting.dart';
import 'package:music_deewane/screens/screen/home_views/setting_views/player_setting.dart';
import 'package:music_deewane/screens/screen/home_views/setting_views/updates_setting.dart';
            ...
            children: [
              ...
              _SettingsSection(
                children: [
                  ...
                  _SettingsTile(
                    title: AppLocalizations.of(context)!.managePreferencesTitle,
                    subtitle: AppLocalizations.of(context)!
                        .managePreferencesArtistsHint,
                    icon: MingCute.user_heart_fill,
                    iconColor: Default_Theme.accentColor2,
                    onTap: () =>
                        _navigate(context, const ManagePreferencesScreen()),
                  ),
                  _SettingsTile(
                    title:
                        AppLocalizations.of(context)!.settingsLanguageCountry,
...
class _SettingsTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      hoverColor: Default_Theme.primaryColor1.withValues(alpha: 0.05),
      child: Padding(
