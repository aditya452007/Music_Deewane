...
class MusicDeewaneSwitch extends StatefulWidget {
  final bool value;
  final VoidCallback onChanged;

  const MusicDeewaneSwitch({
    super.key,
    required this.value,
  ...
  @override
  State<MusicDeewaneSwitch> createState() => _MusicDeewaneSwitchState();
}

class _MusicDeewaneSwitchState extends State<MusicDeewaneSwitch> {
  ...
  @override
  void didUpdateWidget(covariant MusicDeewaneSwitch oldWidget) {
