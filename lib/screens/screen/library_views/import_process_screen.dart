...
String _localizedImportError(BuildContext context, String rawError) {
  ...
  if (rawError == 'This plugin cannot handle the provided URL.') {
    return l10n.importInvalidUrl;
  }
  if (rawError.toLowerCase().contains('no plugin') ||
      rawError.toLowerCase().contains('no importer')) {
    return l10n.importNoPlugin;
  }
  if (rawError.toLowerCase().contains('timeout') ||
      rawError.toLowerCase().contains('timed out')) {
    return l10n.importTimedOut;
  }
  if (rawError
          ...
          child: Column(
            children: [
              ...
              if (s.failedCount > 0) ...[
                ...
                Text(
                  l10n.importPartialResult(s.resolvedCount, s.totalTracks, s.failedCount),
                  textAlign: TextAlign.center,
                  style: TextStyle(
