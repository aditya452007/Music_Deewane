...
import 'package:music_deewane/screens/screen/library_views/playlist_edit_view.dart';
                                ...
                                children: [
                                  _BottomSheetTile(
                                    ...
                                    onTap: () async {
                                      ...
                                      final playerCubit =
                                          ctx.read<MusicDeewanePlayerCubit>();
                                      final list = await libraryCubit
                                          .getPlaylistTracks(title);
                                      if (list != null && list.isNotEmpty) {
                                        playerCubit.player.loadPlaylist(
                                            Playlist(
                                  ...
                                  _BottomSheetTile(
                                    ...
                                    onTap: () async {
                                      ...
                                      final list = await libraryCubit
                                          .getPlaylistTracks(title);
                                      if (list != null && list.isNotEmpty) {
                                        playerCubit.player.addQueueTracks(list);
                                        SnackbarService.showMessage(
