...
class _PlaylistViewState extends State<PlaylistView> {
  ...
  Future<void> _playFromPlaylist(
    ...
    if (!context.mounted || fullPlaylist.tracks.isEmpty) return;
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              FilledButton.icon(
                                ...
                                icon:
                                    const Icon(MingCute.search_line, size: 18),
        ...
        children: [
          ...
          Builder(builder: (ctx) {
            ...
            return _buildActionIcon(
                ...
                l10n.buttonDownload,
                isEmpty ? null : () => _handleDownload(state, l10n));
          }),
          ...
          StreamBuilder<String>(
              stream:
                  context.watch<MusicDeewanePlayerCubit>().player.queueTitle,
