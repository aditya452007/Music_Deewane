...
import 'package:music_deewane/screens/widgets/album_card.dart';
import 'package:music_deewane/screens/widgets/artist_card.dart';
                  ...
                  child: AnimatedContainer(
                    ...
                    child: Text(
                      ...
                      style: Default_Theme.secondoryTextStyleMedium.copyWith(
                        // White bg needs black text — near-white text on
                        // white was invisible.
                        color: isSelected
          ...
          return SliverFillRemaining(
              ...
              child: BlocBuilder<SearchSuggestionBloc, SearchSuggestionState>(
                builder: (context, suggestionState) {
                  final hasCachedHistory =
                      suggestionState is SearchSuggestionLoaded &&
                          suggestionState.dbSuggestionList.isNotEmpty;
                  return Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      SignBoardWidget(
                          ...
                          message:
                              AppLocalizations.of(context)!.emptyNoInternet),
                      if (hasCachedHistory)
                        Padding(
                          padding: const EdgeInsets.only(top: 12),
                          child: Text(
                            AppLocalizations.of(context)!.searchOfflineHint,
                            style: TextStyle(
                                color: Default_Theme.primaryColor1
        ...
        return BlocBuilder<ContentBloc, ContentState>(
          ...
          builder: (context, state) {
            ...
            if (state.searchStatus == SearchStatus.loading && !hasResults) {
              return const SliverFillRemaining(
                  hasScrollBody: false, child: _SearchSkeleton());
            }
            ...
            if (state.searchStatus == SearchStatus.loaded &&
              ...
              final currentPluginId = activePluginNotifier.value;
              final otherPlugins = resolvers
                  .where((p) => p.manifest.id != currentPluginId)
                  .toList();
              return SliverFillRemaining(
                  hasScrollBody: false,
                  child: Column(
                    ...
                    children: [
                      ...
                      if (otherPlugins.isNotEmpty) ...[
                        ...
                        Text(
                          AppLocalizations.of(context)!.searchTrySources,
                          style: TextStyle(
                              color: Default_Theme.primaryColor1
                                  .withValues(alpha: 0.5),
                              fontSize: 12),
                        ...
                        Wrap(
                          ...
                          children: otherPlugins.map((p) {
                            ...
                            return ActionChip(
                              ...
                              backgroundColor: Default_Theme.surfaceColor,
                              side: BorderSide(
                                color: Default_Theme.primaryColor1
                                    .withValues(alpha: 0.15),
                              ),
                              onPressed: () {
                                activePluginNotifier.value = p.manifest.id;
                                contentBloc.add(SetActiveContentPlugin(
                                    pluginId: p.manifest.id));
                                if (query.isNotEmpty) {
                                  contentBloc.add(SearchContent(
                                      query: query,
