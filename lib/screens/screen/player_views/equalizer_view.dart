...
import 'package:music_deewane/screens/screen/home_views/setting_views/custom_switch.dart';
...
class _EqualizerViewState extends State<EqualizerView>
  ...
  // changes from external code (settings restore, revive, Music Deewane settings page).
  ...
  void initState() {
    super.initState();
    _engine = context.read<MusicDeewanePlayerCubit>().player.engine;
