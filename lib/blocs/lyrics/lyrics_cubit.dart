...
import 'package:music_deewane/core/models/exported.dart' hide Lyrics;
import 'package:music_deewane/core/models/lyrics_models.dart';
...
class LyricsCubit extends Cubit<LyricsState> {
  ...
  LyricsCubit(
    ...
    required PluginService pluginService,
        ...
        super(LyricsInitial()) {
    _mediaItemSubscription = playerCubit.player.mediaItem.stream.listen((item) {
      if (item != null) {
