...
class MiniPlayerCubit extends Cubit<MiniPlayerState> {
  final MusicDeewanePlayerCubit _playerCubit;
  StreamSubscription? _sub;

  MiniPlayerCubit({required MusicDeewanePlayerCubit playerCubit})
  ...
  void _listen() {
    _sub = Rx.combineLatest4<MediaItem?, EngineState, bool, bool,
      ...
      _playerCubit.player.mediaItem,
      Rx.defer(() => _playerCubit.player.engine.stateStream, reusable: true),
      Rx.defer(() => _playerCubit.player.engine.playingStream, reusable: true),
      _playerCubit.player.isResolving,
