...
class SettingsState extends Equatable {
  ...
  final List<String> musicLanguages; // preferred music content languages
  final List<Map<String, String>> favoriteArtists; // [{id, name}]
  ...
  SettingsState copyWith({
    ...
    return SettingsState(
      ...
      musicLanguages: musicLanguages != null
          ? List<String>.from(musicLanguages)
          : List<String>.from(this.musicLanguages),
      favoriteArtists: favoriteArtists != null
          ? List<Map<String, String>>.from(
              favoriteArtists.map((e) => Map<String, String>.from(e)))
          : List<Map<String, String>>.from(
              this.favoriteArtists.map((e) => Map<String, String>.from(e))),
    );
  }
