...
import 'package:music_deewane/blocs/local_music/cubit/local_music_cubit.dart';
import 'package:music_deewane/blocs/lyrics/lyrics_cubit.dart';
import 'package:music_deewane/blocs/mini_player/mini_player_cubit.dart';
import 'package:music_deewane/blocs/notification/notification_cubit.dart';
import 'package:music_deewane/blocs/history/cubit/history_cubit.dart';
...
import 'package:music_deewane/blocs/search_suggestions/search_suggestion_bloc.dart';
...
import 'package:music_deewane/plugins/blocs/plugin/plugin_event.dart';
import 'package:music_deewane/repository/music_deewane/download_repository.dart';
import 'package:music_deewane/repository/music_deewane/settings_repository.dart';
import 'package:music_deewane/services/db/dao/cache_dao.dart';
import 'package:music_deewane/services/db/dao/download_dao.dart';
import 'package:music_deewane/services/db/dao/history_dao.dart';
import 'package:music_deewane/services/db/dao/lyrics_dao.dart';
import 'package:music_deewane/services/db/dao/notification_dao.dart';
import 'package:music_deewane/services/db/dao/library_dao.dart';
import 'package:music_deewane/services/db/dao/playlist_dao.dart';
import 'package:music_deewane/services/db/dao/search_history_dao.dart';
import 'package:music_deewane/core/di/service_locator.dart';
import 'package:music_deewane/services/db/dao/track_dao.dart';
import 'package:music_deewane/services/db/dao/settings_dao.dart';
import 'package:music_deewane/services/db/db_provider.dart';
import 'package:music_deewane/blocs/timer/timer_bloc.dart';
import 'package:music_deewane/screens/widgets/global_event_listener.dart';
import 'package:music_deewane/screens/widgets/shortcut_indicator_overlay.dart';
import 'package:music_deewane/screens/widgets/snackbar.dart';
import 'package:music_deewane/services/bootstrap.dart';
import 'package:music_deewane/services/audio_service_initializer.dart';
import 'package:music_deewane/services/keyboard_shortcuts_service.dart';
import 'package:music_deewane/services/shortcut_indicator_service.dart';
import 'package:music_deewane/core/theme/app_theme.dart';
import 'package:music_deewane/services/import_export_service.dart';
import 'package:music_deewane/utils/ticker.dart';
import 'package:music_deewane/utils/url_checker.dart';
...
import 'package:music_deewane/plugins/blocs/import/content_import_cubit.dart';
import 'package:music_deewane/routes/app_router.dart';
import 'package:music_deewane/screens/screen/library_views/cubit/current_playlist_cubit.dart';
import 'package:media_kit/media_kit.dart';
import 'package:share_handler/share_handler.dart';
import 'package:responsive_framework/responsive_framework.dart';
import 'blocs/media_player/music_deewane_player_cubit.dart';
import 'package:flutter_displaymode/flutter_displaymode.dart';
import 'package:music_deewane/services/discord_service.dart';
import 'package:music_deewane/services/db/legacy/legacy_migration_service.dart'
    as legacy_migration;
import 'package:music_deewane/screens/widgets/legacy_migration_overlay.dart';
import 'package:music_deewane/screens/widgets/onboarding_overlay.dart';
import 'package:music_deewane/screens/widgets/plugin_bootstrap_overlay.dart';
...
import 'package:music_deewane/plugins/services/plugin_repository_service.dart';
import 'package:music_deewane/services/shared_url_resolver_service.dart';
...
Future<void> _handleYoutubeVideoIntent(String url) async {
  ...
  if (result.status == SharedUrlResolveStatus.success && track != null) {
    final player = await PlayerInitializer().getMusicDeewanePlayer();
...
late MusicDeewanePlayerCubit playerCubit;
Future<void> setupPlayerCubit() async {
  await setupAudioSession();
  final player = await PlayerInitializer().getMusicDeewanePlayer();
  playerCubit = MusicDeewanePlayerCubit(player);
}
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
            create: (context) => MiniPlayerCubit(playerCubit: playerCubit),
            lazy: true),
        BlocProvider(
        ...
        BlocProvider(
            create: (context) =>
                TimerBloc(ticker: const Ticker(), player: playerCubit)),
        BlocProvider(
        ...
        BlocProvider(
          create: (context) => RecommendationCubit(historyDao),
          lazy: false,
        ),
        BlocProvider(
      ...
      child: BlocBuilder<MusicDeewanePlayerCubit, MusicDeewanePlayerState>(
        builder: (context, state) {
          if (state is MusicDeewanePlayerInitial) {
            return const Center(
              child: SizedBox(
                width: 50,
                height: 50,
