...
class SettingKeys {
  ...
  // ── Preferences (onboarding + manage) ───────────────────────────────────
  /// JSON-encoded list of preferred music language codes (e.g. `["hi","en"]`).
  /// Separate from [languageCode] (UI language) — this filters content.
  static const String musicLanguages = "musicLanguages";

  /// JSON-encoded list of favorite artist entries.
  /// Format: `[{"id":"pluginId::artist123","name":"Arijit Singh"}]`.
  static const String favoriteArtists = "favoriteArtists";
}
