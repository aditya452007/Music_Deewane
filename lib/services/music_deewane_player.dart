...
import 'package:music_deewane/core/constants/sentinel_values.dart';
import 'package:music_deewane/core/constants/setting_keys.dart';
import 'package:music_deewane/core/di/service_locator.dart';
import 'package:music_deewane/plugins/utils/media_id.dart';
import 'package:music_deewane/plugins/errors/plugin_exceptions.dart';
...
import 'package:music_deewane/services/player/media_resolver_service.dart';
import 'package:music_deewane/services/player/player_engine.dart';
import 'package:music_deewane/services/player/player_error_handler.dart';
import 'package:music_deewane/services/player/queue_manager.dart';
import 'package:music_deewane/services/player/related_songs_manager.dart';
import 'package:music_deewane/services/player/recently_played_tracker.dart';
import 'package:music_deewane/services/plugin/plugin_service.dart';
import 'package:music_deewane/services/meta_resolver/smart_track_replacement_service.dart';
...
/// Music Deewane main audio player.
///
...
class MusicDeewanePlayer extends BaseAudioHandler
  ...
  Future<void> _restoreLastSession() async {
    ...
    try {
      ...
      log('Session restore failed: $e', name: 'MusicDeewanePlayer');
    }
  }
  ...
  void _resumePlaybackAfterInterruption() {
    _activateAudioSession().then((granted) {
      ...
      log('Resume after interruption failed: $e', name: 'MusicDeewanePlayer');
    });
  }
  ...
  Future<bool> _activateAudioSession() async {
    try {
      ...
      log('setActive(true) failed: $e', name: 'MusicDeewanePlayer');
      return false;
    }
  }
  ...
  Future<void> _restoreEngineSettings() async {
    try {
      ...
      log('restoreEngineSettings failed: $e', name: 'MusicDeewanePlayer');
    }
  }
  ...
  void _initSubscriptions() {
    ...
    _errorSub = engine.errorStream.listen((error) {
      log('Engine error: $error', name: 'MusicDeewanePlayer');
      final track = _queueManager.currentTrack;
      if (track != null) {
  ...
  Future<void> _doPlay(
    ...
    try {
      ...
      log('Play failed: ${track.title}: $e',
          name: 'MusicDeewanePlayer', stackTrace: stack);
      _errorHandler.handleError(
  ...
  Future<void> revive() async {
    ...
    log('Reviving MusicDeewanePlayer...', name: 'MusicDeewanePlayer');
