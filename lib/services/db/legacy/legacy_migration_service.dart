...
import 'package:music_deewane/core/models/exported.dart' as models;
...
import 'package:music_deewane/services/db/legacy/legacy_db_opener.dart'
    as legacy_opener;
import 'package:music_deewane/services/db/legacy/legacy_global_db.dart'
    as legacy;
...
Future<_MigrationPlan> _buildMigrationPlan(Isar legacyIsar) async {
  ...
  for (var index = 0; index < legacyDownloads.length; index++) {
    ...
    final mediaItem =
        mediaByLegacyMediaId[_stripYoutubePrefix(download.mediaId)];
