...
abstract class AppLocalizations {
  ...
  /// No description provided for @lyricsSearchManually.
  ///
  /// In en, this message translates to:
  /// **'Search manually'**
  String get lyricsSearchManually;

  /// No description provided for @lyricsTryPlugin.
  ///
  /// In en, this message translates to:
  /// **'Try LrcNet plugin'**
  String get lyricsTryPlugin;

  /// No description provided for @lyricsSearchHint.
  ///
  /// In en, this message translates to:
  /// **'Try different spelling or check the artist name.'**
  String get lyricsSearchHint;

  /// No description provided for @lyricsSlowSearch.
  ///
  /// In en, this message translates to:
  /// **'Lyrics search is taking longer than usual...'**
  String get lyricsSlowSearch;

  /// No description provided for @lyricsTimedOut.
  ///
  /// In en, this message translates to:
  /// **'Couldn\'t find lyrics. Try searching manually.'**
  String get lyricsTimedOut;
  ...
  /// No description provided for @playerLoop.
  ///
  /// In en, this message translates to:
  /// **'Loop'**
  ...
  /// No description provided for @playerSkipPrevious.
  ///
  /// In en, this message translates to:
  /// **'Skip to previous'**
  String get playerSkipPrevious;

  /// No description provided for @playerSkipNext.
  ///
  /// In en, this message translates to:
  /// **'Skip to next'**
  String get playerSkipNext;

  /// No description provided for @playerSeekBack10.
  ///
  /// In en, this message translates to:
  /// **'Seek back 10 seconds'**
  String get playerSeekBack10;

  /// No description provided for @playerSeekForward10.
  ///
  /// In en, this message translates to:
  /// **'Seek forward 10 seconds'**
  String get playerSeekForward10;

  /// No description provided for @playerVolumeHint.
  ///
  /// In en, this message translates to:
  /// **'Volume (↑/↓ keys)'**
  String get playerVolumeHint;
  ...
  /// No description provided for @playlistEmptyAdd.
  ///
  /// In en, this message translates to:
  /// **'Add Songs'**
  String get playlistEmptyAdd;
  ...
  /// No description provided for @snackbarAddToPlaylistFailed.
  ///
  /// In en, this message translates to:
  /// **'Couldn\'t add to playlist. It may have been deleted.'**
  String get snackbarAddToPlaylistFailed;
  ...
  /// No description provided for @searchTrySources.
  ///
  /// In en, this message translates to:
  /// **'Try searching on:'**
  String get searchTrySources;

  /// No description provided for @searchYouTubeMusic.
  ///
  /// In en, this message translates to:
  /// **'YouTube Music'**
  String get searchYouTubeMusic;

  /// No description provided for @searchJioSaavn.
  ///
  /// In en, this message translates to:
  /// **'JioSaavn'**
  String get searchJioSaavn;

  /// No description provided for @searchYouTubeVideo.
  ///
  /// In en, this message translates to:
  /// **'YouTube Video'**
  String get searchYouTubeVideo;

  /// No description provided for @searchOfflineHint.
  ///
  /// In en, this message translates to:
  /// **'Your recent searches are shown below'**
  ...
  /// No description provided for @libraryEmptyLocal.
  ///
  /// In en, this message translates to:
  /// **'Scan local files'**
  String get libraryEmptyLocal;
  ...
  ///
  /// In en, this message translates to:
  /// **'Are you sure you want to reset Music Deewane? This will delete all your data and cannot be undone.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'See if a newer version of Music Deewane is available.'**
  ...
  /// No description provided for @offlineEmptyHint.
  ///
  /// In en, this message translates to:
  /// **'Download tracks from Search or Playlists to listen offline.'**
  String get offlineEmptyHint;

  /// No description provided for @offlineEmptyBrowse.
  ///
  /// In en, this message translates to:
  /// **'Browse Music'**
  String get offlineEmptyBrowse;
  ...
  ///
  /// In en, this message translates to:
  /// **'Enjoying Music Deewane? A small tip keeps it blooming. 🌸'**
  ...
  ///
  /// In en, this message translates to:
  /// **'I want Music Deewane to keep improving.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'This URL doesn\'t seem right. Make sure it\'s a valid playlist URL.'**
  String get importInvalidUrl;

  /// No description provided for @importNoPlugin.
  ///
  /// In en, this message translates to:
  /// **'No import plugin available. Install one from Plugin Manager.'**
  String get importNoPlugin;

  /// No description provided for @importTimedOut.
  ///
  /// In en, this message translates to:
  /// **'Import timed out. Check your connection and try again.'**
  String get importTimedOut;

  /// No description provided for @importPartialResult.
  ///
  /// In en, this message translates to:
  /// **'{found} of {total} tracks found. {failed} tracks couldn\'t be imported.'**
  String importPartialResult(int found, int total, int failed);
  ...
  /// No description provided for @playerTryingAgain.
  ///
  /// In en, this message translates to:
  /// **'Having trouble playing this track...'**
  String get playerTryingAgain;

  /// No description provided for @playerAllSourcesFailed.
  ///
  /// In en, this message translates to:
  /// **'Couldn\'t play from any source'**
  String get playerAllSourcesFailed;

  /// No description provided for @playerTryAlternative.
  ///
  /// In en, this message translates to:
  /// **'Try another source'**
  String get playerTryAlternative;

  /// No description provided for @playerQueueFinished.
  ///
  /// In en, this message translates to:
  /// **'Queue finished. Add more music?'**
  String get playerQueueFinished;
  ...
  ///
  /// In en, this message translates to:
  /// **'Some plugins could not be installed. You can still use Music Deewane — plugins will be retried on next launch.'**
  ...
  /// No description provided for @pluginEmptyTitle.
  ///
  /// In en, this message translates to:
  /// **'No plugins installed'**
  String get pluginEmptyTitle;

  /// No description provided for @pluginEmptyHint.
  ///
  /// In en, this message translates to:
  /// **'Install plugins to search and play music from various sources.'**
  String get pluginEmptyHint;

  /// No description provided for @pluginEmptyInstall.
  ///
  /// In en, this message translates to:
  /// **'Install Recommended Plugins'**
  String get pluginEmptyInstall;

  /// No description provided for @pluginInstallFailed.
  ///
  /// In en, this message translates to:
  /// **'Failed to install {plugin}'**
  String pluginInstallFailed(String plugin);
  ...
  /// No description provided for @pluginStatusLoaded.
  ///
  /// In en, this message translates to:
  /// **'Loaded'**
  String get pluginStatusLoaded;

  /// No description provided for @pluginStatusNotLoaded.
  ///
  /// In en, this message translates to:
  /// **'Not loaded'**
  String get pluginStatusNotLoaded;
  ...
  /// No description provided for @pluginAllFailedTitle.
  ///
  /// In en, this message translates to:
  /// **'No music sources available'**
  String get pluginAllFailedTitle;

  /// No description provided for @pluginAllFailedHint.
  ///
  /// In en, this message translates to:
  /// **'Install plugins from Plugin Manager to search and play music.'**
  String get pluginAllFailedHint;

  /// No description provided for @pluginAllFailedAction.
  ///
  /// In en, this message translates to:
  /// **'Open Plugin Manager'**
  String get pluginAllFailedAction;
  ...
  /// No description provided for @onboardingArtistsTitle.
  ///
  /// In en, this message translates to:
  /// **'Pick Your Favorites'**
  String get onboardingArtistsTitle;

  /// No description provided for @onboardingArtistsSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Select at least 3 artists you love. We\'ll personalize your experience.'**
  String get onboardingArtistsSubtitle;

  /// No description provided for @onboardingSearchArtists.
  ///
  /// In en, this message translates to:
  /// **'Search artists...'**
  String get onboardingSearchArtists;

  /// No description provided for @onboardingNoArtistsFound.
  ///
  /// In en, this message translates to:
  /// **'No artists found. Try a different search.'**
  String get onboardingNoArtistsFound;

  /// No description provided for @onboardingSearchArtistsHint.
  ///
  /// In en, this message translates to:
  /// **'Type an artist name above to search.\nResults will appear here.'**
  String get onboardingSearchArtistsHint;

  /// No description provided for @onboardingPluginsNotLoaded.
  ///
  /// In en, this message translates to:
  /// **'Music sources aren\'t loaded yet.\nYou can set this up later in Settings.'**
  String get onboardingPluginsNotLoaded;
  ...
  ///
  /// In en, this message translates to:
  /// **'Tap Next to skip for now.'**
  String get onboardingSkipHint;

  /// No description provided for @onboardingMusicLangTitle.
  ///
  /// In en, this message translates to:
  /// **'Music Languages'**
  String get onboardingMusicLangTitle;

  /// No description provided for @onboardingMusicLangSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Choose languages you enjoy listening to. We\'ll use this for recommendations.'**
  String get onboardingMusicLangSubtitle;

  /// No description provided for @onboardingMusicLangSelected.
  ///
  /// In en, this message translates to:
  /// **'{count} language(s) selected'**
  String onboardingMusicLangSelected(int count);
  ...
  /// No description provided for @forYouBecause.
  ///
  /// In en, this message translates to:
  /// **'Because you listened to {artist}'**
  String forYouBecause(String artist);

  /// No description provided for @forYouBasedOnHistory.
  ///
  /// In en, this message translates to:
  /// **'Based on your listening history'**
  String get forYouBasedOnHistory;

  /// No description provided for @forYouBasedOnArtists.
  ///
  /// In en, this message translates to:
  /// **'From your favorite artists'**
  String get forYouBasedOnArtists;
  ...
  /// No description provided for @managePreferencesTitle.
  ///
  /// In en, this message translates to:
  /// **'Manage Preferences'**
  String get managePreferencesTitle;

  /// No description provided for @managePreferencesArtists.
  ///
  /// In en, this message translates to:
  /// **'Favorite Artists'**
  String get managePreferencesArtists;

  /// No description provided for @managePreferencesArtistsHint.
  ///
  /// In en, this message translates to:
  /// **'Update your favorite artists to improve recommendations.'**
  String get managePreferencesArtistsHint;

  /// No description provided for @managePreferencesMusicLangs.
  ///
  /// In en, this message translates to:
  /// **'Music Languages'**
  String get managePreferencesMusicLangs;

  /// No description provided for @managePreferencesMusicLangsHint.
  ///
  /// In en, this message translates to:
  /// **'Choose languages for music recommendations.'**
  String get managePreferencesMusicLangsHint;

  /// No description provided for @managePreferencesSave.
  ///
  /// In en, this message translates to:
  /// **'Save'**
  String get managePreferencesSave;

  /// No description provided for @managePreferencesSaved.
  ///
  /// In en, this message translates to:
  /// **'Preferences saved'**
  String get managePreferencesSaved;
}
